...
class TestMatchUsers:
    ...
    def test_fields(self):
        ...
        expected_res = {'TripStartLocation': [
            'Missing data for required field.'], 'TripStopLocation': ['Missing data for required field.']}
    ...
    def test_field_types(self):
        ...
        res_json = response.get_json()
        expected_res = {"TripStartLocation": [
            "Not a valid list."], "TripStopLocation": ["Not a valid list."]}
        assert res_json == expected_res
