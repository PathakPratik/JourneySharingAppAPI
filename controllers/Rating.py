...
from services.UserModule import validate_rating_form, update_user_in_db, find_user_by_id
...
def update_rating():
    ...
    user.current_rating = ((user.current_rating * user.rating_count)  + int(new_ratings)) / (user.rating_count + 1)
    user.rating_count += 1 
