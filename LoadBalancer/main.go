...
func main() {
	...
	// lb.AddServer(server.CreateNewServer("server-3", "http://0.0.0.0:5000"))
	// lb.AddServer(server.CreateNewServer("server-4", "http://0.0.0.0:5000"))
	// lb.AddServer(server.CreateNewServer("server-5", "http://0.0.0.0:5000"))
	fmt.Println(lb)
